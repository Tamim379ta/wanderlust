...
const EditModal = ({ data }) => {
  const { _id, imageUrl, departureDate, category, country, description, destinationName, price, duration } = data;
  ...
  return (
    <div>
      <Modal>
        <Button className={'rounded-xs'} variant="outline"> <BiEdit /> Edit</Button>
